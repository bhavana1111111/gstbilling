<?php 
    ...
    else
    {
        ...
        $q2="SELECT * FROM purchase_ret_mast S INNER JOIN supp_mast C ON S.Supp_Id=C.Supp_Id WHERE S.Prn_No='{$_SESSION['invn']}'";
...
<div id="invoice" class="offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12 padding">
    <div id="main" class="card">
        <div class="card-header p-4">
            <a class="pt-2 h3 font-weight-bold" data-abc="true">PURCHASE RETURN</a>
        ...
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-sm-6">
                    ...
                    <h3 class="text-dark mb-1"><?= $row2['Supp_Name']?></h3>
            ...
            <div class="table-responsive-sm">
                <table class="table table-striped" border="2">
                    ...
                    <tbody>
                        <?php
                            $q3="SELECT * FROM purchase_ret_det S INNER JOIN prod_mast P ON S.Pr_Id=P.Pr_Id WHERE S.Inv_No='{$_SESSION['invn']}'";
                        ...
                        <tr>
                            <?php
                                $q4="SELECT sum(Pr_Qty),sum(Amt-Disc),sum(Total_Amt) FROM purchase_ret_det WHERE Inv_No='{$_SESSION['invn']}'";
