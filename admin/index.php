...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top p-3" id="mainNav">
  <div class="container-fluid">
    <img src="images/logo1.png" alt="Logo" height="35" width="35">
        ...
        <div class="col-lg-8 mx-auto">
          ...
          <div class="row">
            <div class="col text-center text-white">
              <img src="images/aprajita.jpg" class="card-img rounded-circle" style="height: 250px; width: 250px" alt="Aprajita Singh">
              <h4 class="font-weight-bold">Ms. Aprajita Singh</h4>
              <p class="card-text">Website Designer<br>Instagram : @ms.rajput</p>
            </div>
            <div class="col text-center text-white">
              <img src="images/bhavna.jpg" class="card-img rounded-circle" style="height: 250px; width: 250px" alt="Bhavna Bhandari">
              <h4 class="font-weight-bold">Ms. Bhavna Bhandari</h4>
              <p class="card-text">Website Planner & Programmer<br>Instagram : @bhavna</p>
            </div>
          </div>
          </div>
        </div>
...
<footer class="footer mt-auto py-4 bg-dark">
  <div class="container text-center">
    <span class="text-muted">Made with&nbsp;<span style="font-size: 1rem"><i class="fas fa-heart"></i></span>&nbsp;&&nbsp;<span style="font-size: 1rem"><i class="fas fa-coffee"></i></span>&nbsp;by Aprajita & Bhavna.</span><br>
    <span class="text-center text-muted"><span style="font-size: 1rem"><i class="fas fa-copyright"></i></span>&nbsp;invoicefy 2021</span>
  </div>
</footer>
</div>
