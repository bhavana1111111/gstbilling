...
<td><input type="text" name="qty" class="form-control" placeholder="Quantity"></td>
<td><input type="text" name="rate2" class="form-control" placeholder="Rate" required></td>
<td><input type="text" name="disc" class="form-control" placeholder="Discount"></td>
<td><input type="text" name="cgstp" class="form-control" placeholder="CGST %" value='<?= $row5["Gst_Rate"]/2?>' readonly></td>
<td><input type="text" name="cgsta" class="form-control" placeholder="CGST" readonly></td>
<td><input type="text" name="sgstp" class="form-control" placeholder="SGST %" value="<?= $row5["Gst_Rate"]/2?>" readonly></td>
<td><input type="text" name="sgsta" class="form-control" placeholder="SGST" readonly></td>
