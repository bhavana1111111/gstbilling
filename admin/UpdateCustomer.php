...
<div id="main" class="container bg-light rounded bg-white shadow-sm">	
	<form class="form-group p-3 needs-validation" method="POST" name="Supplier" onsubmit="return validateForm()">
		<h4 class="text-primary">Update Customer</h4>
    <hr class="mb-4">
...
<?php
  if($_POST)
  {
    ...
    $gsn=$_POST['GSTNNo'];
    $mbn=$_POST['Mob_No'];
    $q2="UPDATE cust_mast SET Address='".$add."',City='".$ct."',State='".$st."',Pincode=".$pc.",Gstn_No='".$gsn."',Mob_No=".$mbn." WHERE Cust_Id='{$_SESSION["cusid"]}'";
