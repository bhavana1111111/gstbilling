<?php 
    ...
    $fdt=$_SESSION['fdt'];
    $tdt=$_SESSION['tdt'];
    $q1="SELECT S.Supp_Id,Supp_Name,Address,City,State,Pincode,Gstn_No,Mob_No,sum(Final_Amt) as PurchaseT FROM purchase_mast P INNER JOIN Supp_mast S ON S.Supp_Id=P.Supp_Id WHERE S.Client_id='{$clid}' AND Inv_date>='{$fdt}' AND Inv_date<='{$tdt}' GROUP BY S.Supp_Id ORDER BY S.Supp_Id";
    ...
    <div class="table-responsive-sm text-center">
        <table  id="tblCustomers"class="table table-striped text-center" border="2">
            <thead>
                ...
                <tr>
                    <th class="center" colspan="10">Supplierwise Purchase Report</th>
                </tr>
                <tr>
        ...
        <script type="text/javascript">
            function Export() {
                $("#tblCustomers").table2excel({
                    filename: "Supplierwise Purchase.xls"
                });
            }
        </script>
    </div>
