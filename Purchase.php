		  	...
		  	<tbody>
				...
				<tr>
				    ...
				    <td><label class="form"><?= $row3["Gst_Rate"]/2?></label></td>
				  	<td><label class="form"><?= round(($row3["Total_Amt"]/(1+($row3["Gst_Rate"]/100)))*$row3["Gst_Rate"]/200, 2) ?></label></td>
				    <td><label class="form"><?= $row3["Gst_Rate"]/2?></td>
				   	<td><label class="form"><?= round(($row3["Total_Amt"]/(1+($row3["Gst_Rate"]/100)))*$row3["Gst_Rate"]/200, 2)?></td>
