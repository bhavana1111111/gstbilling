<?php 
	...
	$q5="SELECT * from prod_mast P INNER JOIN purchase_det S ON P.Pr_Id=S.Pr_Id WHERE P.Pr_Id='".$pr_id."' AND S.Inv_No='".$_SESSION['oinvn']."'";
...
<td><input type="text" name="rate2" class="form-control" placeholder="Rate" value='<?= $row5["Amt"]/$row5["Pr_Qty"]?>' readonly></td>
...
<td><input type="text" name="cgsta" class="form-control" placeholder="CGST" value='<?= ((($row5["Amt"]/$row5["Pr_Qty"])*$row5['C_Qty'])-$row5["Disc"])*$row5["Gst_Rate"]/200?>' readonly></td>
<td><input type="text" name="sgstp" class="form-control" placeholder="SGST %" value="<?= $row5["Gst_Rate"]/2?>" readonly></td>
<td><input type="text" name="sgsta" class="form-control" placeholder="SGST" value='<?= ((($row5["Amt"]/$row5["Pr_Qty"])*$row5['C_Qty'])-$row5["Disc"])*$row5["Gst_Rate"]/200?>' readonly></td>
